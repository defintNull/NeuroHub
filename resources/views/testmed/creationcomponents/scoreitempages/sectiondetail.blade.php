                    ...
                    <div id="jump-container" class="hidden mt-4">
                        <div class="flex flex-col items-center">
                            <div class="flex flex-col items-center mt-4 justify-center w-2/3">
                                ...
                                @if (isset($jump))
                                    @if ($jump)
                                    <input id="jumplenght" name="jumplenght" value="{{ $section->jump->count() }}" class="hidden"/>
                                    @else
                                            ...
                                            <div class="rangecontainer grid grid-cols-4 items-start w-full">
                                                <div class="flex flex-col items-center mt-4 justify-center">
                                                    <div class="flex flex-row items-center justify-center">
                                                        <p class="mr-4">From:</p>
                                                        <input type="text" name="from-{{ $i+1 }}" value="{{ $section->jump[$i][0] }}" class="rangeinput rounded-lg w-20"/>
                                                    </div>
                                                ...
                                                <div class="flex flex-col items-center mt-4 justify-center">
                                                    <div class="flex flex-row items-center justify-center">
                                                        <p class="mr-4">To:</p>
                                                        <input type="text" name="to-{{ $i+1 }}" value="{{ $section->jump[$i][1] }}" class="rangeinput rounded-lg w-20"/>
                                                    </div>
