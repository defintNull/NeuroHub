                        ...
                        @if (isset($update))
                            @if (isset($fields["personal"]))
                                @for ($i=0; $i<count($fields["personal"]); $i++)
                                    ...
                                    <input id="checkbox-personal-text-{{ $i+1 }}" name="checkboxpersonal{{ $i+1 }}" type="text" value="{{ $fields["personal"][$i] }}" class="singlecheck w-full ms-2 text-sm font-medium text-gray-900 rounded">
                                    </div>
