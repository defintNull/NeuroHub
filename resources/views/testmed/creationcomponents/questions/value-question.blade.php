                            ...
                            @if (isset($fields["personal"]))
                                @for ($i=0; $i<count($fields["personal"]); $i++)
                                    <div class="valuelistitem singlecheck flex items-center p-2 rounded hover:bg-gray-100">
                                        <input checked id="checkbox-personal-{{ $i+1 }}" type="checkbox" class="checkboxpersonal singlecheck w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                        <input id="checkbox-personal-text-{{ $i+1 }}" name="checkboxpersonal{{ $i+1 }}" type="text" value="{{ $fields["personal"][$i] }}" class="checkboxpersonaltext singlecheck w-full ms-2 mr-1 text-sm font-medium text-gray-900 rounded">
