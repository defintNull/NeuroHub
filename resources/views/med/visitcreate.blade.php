                    ...
                    <section>
                        ...
                        <form method="post" action="{{ route('med.visits.store') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="diasnosis" class="block mt-1 w-full" type="text" name="diasnosis" required autofocus autocomplete="given-name" />
                            ...
                            <div>
                                ...
                                <x-text-input id="treatment" class="block mt-1 w-full" type="text" name="treatment" required autofocus autocomplete="family-name" />
