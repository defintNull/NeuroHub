            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="post" action="{{ route('med.patients.store') }}" class="mt-6 space-y-6">
                            @csrf
                            @method('')
                            ...
                            <div>
                                ...
                                <x-text-input id="telephone" class="block mt-1 w-full" type="text" name="telephone" required autofocus autocomplete="tel" />
